...
+ Cluster | Extensible Node.JS multi-core server manager with plugins support
...
+ Rest for Haskell | Packages for defining APIs, running them, generating client code and documentation | Write REST APIs in Haskell, generate documentation and client libraries
...
+ WTF, HTML and CSS? | Common reasons your HTML and CSS may be fucked
...
### DSL/Spec/Test/Behavior/Assertion
...
+ M/Monit | Easy, proactive monitoring of Unix systems, network and cloud services
...
Dato | GraphLab | A framework for large-scale machine learning and graph computatio
  GraphLab Create
...
+ Ganttify | Gantt charts for Basecamp, Google Calendar and Trello

+ Asana
  + Instagantt | Gantt charts for Asana
+ BamBam!
+ Redbooth (Teambox)
+ Tom's Planner | Project Planner | Online Gantt Chart
+ Teamweek | Free Project Planner, Team Calendar With Online Gantt Charts
+ Instagannt
+ GanttProject | free desktop project management tool
+ Viewpath | Online Project Management
+ Ganttic | The fastest way to manage anything | Resource planning and project scheduling program
...
+ Lighthouse
+ Taskboard
+ refreshrunner | A Task Manager You'll Want To Impress
+ OnTime | Scrum Software, Agile Project Management, Bug Tracker and Help Desk

+ waffle.io
+ Peak | the automated way to keep track of what everyone is working on
+ Flow

+ WakaTime

+ Project Management Institure | PMI + the World’s Leading Professional Association for Project Management

### Tasks/Todo/Check List
...
+ Checkvist | Keyboard driven online outliner and task manager
...
+ Everhour | Painless Online Time Tracking
...
+ Focus A Lot | an app that helps you be more productive
...
AFNetworking | a delightful networking framework for iOS and OSX

Notes/Information/Knowledge
---------------------------

M Haidar Hanif's Docs

+ Freebase
+ DataSift

+ Quora
+ Crowdbase | Your Collective Memory | Centralize, Organize and Share Knowledge | A beautiful home for your team's knowledge
+ AnswerHub
+ SerKey
+ Stack Exchange
+ reSRC | Find Y resources about X in 0 minutes
...
+ Anchor | More than a wiki

+ InTech | InTechOpen | Open Science Open Minds
...
+ Google Bookmarks
+ Google Keep
+ Likeastore | Social bookmarks and favorites
+ Pocket
+ Instapaper
+ Delicious
...
+ Poche
+ Shaarli
+ Kippt | Build your online library of amazing things | Use Kippt to collect research, stories, inspiration and notes
...
+ Vibes | Mobile Marketing Solutions | Mobile Platform | Mobile CRM
...
+ Visualize your Git! | Tool to visualize your git workflow, in a pretty graph
+ Git Chess
+ Tower | The most powerful Git client for Mac
+ github/gitignore | A collection of useful .gitignore templates
+ git | the simple guide
+ git-sh | A customized bash environment suitable for git work
+ git-fish | Github Web Hook Listener in Node.js

+ Mercurial
+ Bazaar
+ Dat Data | Data package management | Version control for data | Real-time replication and versioning for large tabular data sets
+ Versioned Domain Model (VDM) | Python library for revisioning/versioning of databases
+ Darcs | free and open source, cross-platform version control system
+ Subversion | SVN

+ Draft
+ Hemingway App makes your writing bold and clear
+ Penflip | a social writing platform | collaborative writing and version control
+ Noted · Research together
+ Typewrite | Simple, Real-time Collaborative Writing Environment
+ Poetica | Make words easy
+ Onword | Just write
+ hackpad | Smart collaborative documents
+ Editorially
...
+ GitHub
  ...
  + Sourcegraph
  + 5 minute fork
  + Octocard | Highly flexible github card widget for every GitHub lover
  + Preview
    + rawgithub.com
  ...
  + Repos.io | Search and manage code repositories
+ Google Code
+ BitBucket
+ Launchpad
+ GitLab
...
+ Springloops
+ Planio | Online Project Management and Redmine Hosting
+ Black Duck
  + Open Hub | Ohloh | The open source network
    + Ohloh Code Search
+ Assembla | Accelerate Development with Agile Teams and Continuous Delivery | Keeps Code, Tasks, and Teams Happily Together
+ Gitolite
...
Kibin | Editing and Proofreading Services
...
+ Buffer | Smarter Way to Share on Social Media | The easiest way to publish on social media
+ Falcon Social
+ Klout
+ Shareaholic
...
Balloon — Contact Forms. Reimagined.
...
Ship.io | Continuous Integration for Mobile
